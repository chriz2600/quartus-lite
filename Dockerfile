...
# extract quartus prime
RUN cd /root/quartus && tar xvf Quartus-lite-17.0.0.595-linux.tar

# run quartus prime setup
RUN /root/setup 17.0 && echo "done"
# housekeeping
RUN rm -rf /root/quartus
